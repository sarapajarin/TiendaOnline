...
@Component({
  selector: 'app-graphic-pequeno2',
  imports: [BaseChartDirective],
  templateUrl: './graphic-pequeno2.component.html',
  styleUrl: './graphic-pequeno2.component.scss'
})
export class GraphicPequeno2Component implements OnInit {
